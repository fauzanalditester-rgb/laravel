                    ...
                    <form action="{{ route('penjualan.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="customer" name="customer" type="text" class="mt-1 block w-full"
                                    placeholder="Nama Pelanggan / Perusahaan" :value="old('customer')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="jenis_material" name="jenis_material" type="text"
                                    class="mt-1 block w-full" placeholder="Jenis Produk" :value="old('jenis_material')"
                                    required />
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="jumlah" name="jumlah" type="number" step="0.01"
                                        class="mt-1 block w-full" placeholder="0.00" :value="old('jumlah')" required />
                                </div>
                                <div>
                                    <x-input-label for="satuan" :value="__('Satuan')" />
                                    <x-text-input id="satuan" name="satuan" type="text" class="mt-1 block w-full"
                                        placeholder="Satuan" :value="old('satuan')" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_satuan" name="harga_satuan" type="number"
                                    class="mt-1 block w-full" placeholder="0" :value="old('harga_satuan')" required />
                                <x-input-error class="mt-2" :messages="$errors->get('harga_satuan')" />
                            </div>

                            <div>
                                <x-input-label for="status_bayar" :value="__('Status Pembayaran')" />
