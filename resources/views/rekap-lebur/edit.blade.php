    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border-t-4 border-gold-500">
                <div class="p-8">
                    <form action="{{ route('rekap-lebur.update', $record) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="berat_awal" name="berat_awal" type="number" step="0.01"
                                    class="mt-1 block w-full" :value="old('berat_awal', $record->berat_awal)"
                                    required />
                            ...
                            <div>
                                ...
                                <x-text-input id="berat_hasil" name="berat_hasil" type="number" step="0.01"
                                    class="mt-1 block w-full" :value="old('berat_hasil', $record->berat_hasil)"
                                    required />
